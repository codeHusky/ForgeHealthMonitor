...
public final class HttpUtil {
    ...
    private static final int RETRY_LIMIT = Integer.getInteger("com.codehusky.spikelogger.stackdeobf.stackdeobf.http-retry-count", 3);
    ...
    public static CompletableFuture<HttpResponseContainer> getAsync(HttpRequest request, Executor executor, int depth) {
        ...
        HealthMonitor.getLogger().info("Trying to request {} {}... (try #{})",
